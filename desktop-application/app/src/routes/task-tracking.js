...
module.exports = router => {
  ...
  router.serve('tracking/start', async request => {
    ...
    try {
      ...
      const taskId = typeof requestData.taskId === 'string' ? requestData.taskId : undefined;
      ...
      // Starting tracker
      await TaskTracker.start(taskId);
  ...
  router.serve('tracking/stop', async request => {
    ...
    try {
      ...
      return request.send(403, {
        message: 'Tracking stop is restricted by organization policy',
        id: 'ERTR403',
      });
