    ...
    <el-main>
      <el-row class="section">
        ...
        <el-upload
          ...
          <div class="el-upload__tip" slot="tip">{{ $t('only .Tracker files are accepted') }}</div>
        </el-upload>
      </el-row>
      <el-row class="section">
  ...
  methods: {
      ...
      if (intervalsRes.code === 200) {
        try {
          ...
          zip({
            ...
            aElement.setAttribute('download', 'Intervals.Tracker');
    ...
    async exportScreenshots(){
      ...
      if (screenshotsArchiveRes.code === 200) {
        try {
            const aElement = document.createElement('a');
            aElement.setAttribute('download', 'Screenshots.Tracker');
