...
class DeprecatedApiException extends HttpException
{
    public function __construct()
    {
        ...
        \Log::warning("Deprecated method {$deprecatedMethod} called, update Tracker client", [
        ...
        parent::__construct("Deprecated method {$deprecatedMethod} called, update Tracker client");
    }
}
