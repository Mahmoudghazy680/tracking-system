...
use App\Http\Requests\Reports\TopWebsitesReportRequest;
...
class TopWebsitesReportController
{
    public function __invoke(TopWebsitesReportRequest $request): JsonResponse
    {
        $user = $request->user();
        ...
        $export = TopWebsitesReportExport::init(
     ...
     * @throws Throwable
     */
    public function download(TopWebsitesReportRequest $request): JsonResponse
    {
        $user = $request->user();
