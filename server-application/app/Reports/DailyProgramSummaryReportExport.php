...
class DailyProgramSummaryReportExport extends AppReport implements FromCollection, WithMapping, ShouldAutoSize, WithHeadings, WithStyles
{
    use Exportable;
    ...
    private function queryReport(): Collection
    {
        ...
        $programNameExpression = TrackedApplicationJoin::programDisplayNameExpression('tas');
        $normalizedExecutableExpression = TrackedApplicationJoin::normalizedExecutableExpression('tas');
        ...
        return $query
            ->selectRaw(
                "ti.user_id,
                 ...
                 {$normalizedExecutableExpression} AS executable,
    ...
    {
        return 'daily_program_summary_report';
    }

    public function getLocalizedReportName(): string
    {
        return 'Daily Program Summary Report';
    }
}